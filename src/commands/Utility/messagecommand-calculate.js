...
module.exports = new MessageCommand({
    ...
    run: async (client, message, args) => {
        ...
        if(message.mentions.members.size > 0){
            ...
            if(controlledMember == undefined) return message.reply({ content: "User not found!" });
            if(controlledMember.user.bot) return message.reply({ content: "User is bot!" });
            if(controlledMember.id == "724621100541280256") return;
            if(controlledMember.id == "1022141376130994226") return;
            if(controlledMember.id == "793210099970998282") return;
            ...
            if(!args[1]){
                for (let id = 0; id < message.guild.memberCount; id++) {
                    ...
                    if(controlledMember == undefined) return;
                    if(controlledMember.user.bot) return;
                    if(controlledMember.id == "724621100541280256") return;
                    if(controlledMember.id == "1022141376130994226") return;
                    if(controlledMember.id == "793210099970998282") return;
