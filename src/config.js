const config = {
    ...
    users: {
        ownerId: '730860373862908071', // The bot owner ID, which is you.
        developers: ['730860373862908071', ''] // The bot developers, remember to include your account ID with the other account IDs.
    },
